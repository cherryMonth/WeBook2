...
def get_category():
    ...
    docs = temp.order_by(Category.id.desc()).paginate(_id, 1, error_out=True).items
    docs_html_list = list()
    for doc in docs:
        html = """<li id="{}" class="have-img">
                    ...
                    <div style="margin-top: 20px;" class="container">
                        ...
                        <span class="glyphicon glyphicon-send">{}</span>
                            <a target="_blank" style="margin-left: 10px" class='glyphicon glyphicon-eye-open' href="/display/{}">{}</a>
    ...
    ...: -fA-F][0-9a-fA-F]))+""", doc.content, re.S)
        ...
        ext = Extractor(1)
        content = ext.getPlainText(markdown.markdown(doc.content, extensions=exts))[:80] + "..."
        print(content)
